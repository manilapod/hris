...
INSERT INTO EMPLOYEES(BENEFITS_ID, FIRST_NAME, LAST_NAME, EMAIL, BIRTHDATE, JOB_ROLE, ADDRESS, TELEPHONE_NUMBER, STATE, IN_TRAINING, PERFORMANCE, STARTED_DATE, LAST_UPDATES) 
...
INSERT INTO BENEFITS(EMPLOYEES_ID, RETIREMENT_ID, INSURANCE_ID, LIFE_INSURANCE, HEALTH_INSURANCE, RETIREMENT_PLANS, TUITION_ASSISTANCE) 
...
INSERT INTO INSURANCE(BENEFITS_ID, LIFE_PREM, HEALTH_PREM) 
VALUES(2,'5.4','3.6'),
(4,'6.7','2.4'),
(4,'3.2','6.4'),
(5,'5.7','6.3');
...
INSERT INTO PAYROLL(EMPLOYEES_ID, HOURLY_RATE, GROSS_SALARY, SALARY, YEARLY_BONUS, STATE_TAX, FEDERAL_TAX, EMPLOYMENT_TYPE, WEEKLY_HOURS, PAY_CYCLE, EXTRA_HOURS, EFFECTIVE) 
...
INSERT INTO RETIREMENT(BENEFITS_ID, 401K_AMOUNT, 403B_AMOUNT, 457B_AMOUNT) 
...
INSERT INTO TRAINING(EMPLOYEES_ID, TRAINNE_NAME, COMPLETED) 
